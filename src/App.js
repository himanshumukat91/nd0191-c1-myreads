...
class App extends PureComponent {
  ...
  componentDidMount = async() => {
    ...
    res && this.setState({myBooks: res});
  }

  updateShelf = (book, newShelf) =>{
    let isFound = false;
    const newBook = this.state.myBooks.map((i) =>{
     if(i.id === book.id){
       i.shelf = newShelf;
       isFound = true;
     }
  ...
  render() {
    return (
      <BrowserRouter>
        <Routes>        
            <Route path='/search' element={<BookSearch myBooks={this.state.myBooks} updateShelf={this.updateShelf} />} /> 
            <Route path='/' element={<BookList myBooks={this.state.myBooks} updateShelf={this.updateShelf} />} /> 
        </Routes>
      </BrowserRouter>
    );
  }
